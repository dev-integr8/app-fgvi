...
#Region "SUBS"
    ...
    Private Sub LoadUserDetails()
        Try
            Dim query As String
            query = " SELECT    UserID, UserName, LoginName, Password, UserLevel, RefID, EmailAddress, ContactNo, Status, DateLastLogin, Signature, Position " & _
                    " FROM      tblUser " & _
            ...
            If SQL.SQLDR.Read Then
                ...
                lblPosition.Text = SQL.SQLDR("Position").ToString
...
#End Region
    ...
    Private Sub AddSignatureToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles AddSignatureToolStripMenuItem.Click
        If Not AllowAccess("UAR_CHANGE") Then
            msgRestricted()
        Else
            Dim f As New frmUser_Add
            f.Type = "CHANGE SIGNATURE"
            f.ShowDialog(User_ID)
