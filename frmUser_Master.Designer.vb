...
Partial Class frmUser_Master
    ...
    Private Sub InitializeComponent()
        ...
        'pbSignature
        '
        resources.ApplyResources(Me.pbSignature, "pbSignature")
        ...
        'tsbTools
        '
        Me.tsbTools.DropDownItems.AddRange(New System.Windows.Forms.ToolStripItem() {Me.tsbCopyPR, Me.LockAccountToolStripMenuItem, Me.AddSignatureToolStripMenuItem})
        ...
        resources.ApplyResources(Me.AddSignatureToolStripMenuItem, "AddSignatureToolStripMenuItem")
        '
        'tsbClose
        '
